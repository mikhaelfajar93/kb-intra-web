                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="d-flex align-items-center text-info"
                                                href="{{ route('dashannoun.view_announcement', $viewannouncement->id) }}"
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu-1">
                                            <li><a class="dropdown-item" href="/home_accounting">View</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <h5>Accounting</h5>
                                    <p class="mb-0">0 Items</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu-1">
                                            <li><a class="dropdown-item" href="/announ_compliance">View</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <h5>Compliance</h5>
                                    <p class="mb-0">{{ $file_compliance }} Items</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu-1">
                                            <li><a class="dropdown-item" href="/announ_hrd">View</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <h5>HRD</h5>
                                    <p class="mb-0">{{ $file_hrd }} Items</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu-1">
                                            <li><a class="dropdown-item" href="/announ_legal">View</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="mt-4">
                                    <h5>Legal</h5>
                                    <p class="mb-0">{{ $file_legal }} Items</p>
                                </div>
                            </div>
                        </div>
                    </div>
