...
@section('announ_hrd_active', 'active') --}}
@section('announcement_active', 'active')
@section('content_header')
    @can('add hrd')
        <a href="/hrd-input-announcement" class="btn btn-danger">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Announcement HRD</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                                                ...
                                                <div class="mb-2 d-flex align-items-center">
                                                    ...
                                                    @can('update hrd')
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('hrd.edit_announcements', $listannoun->id) }}"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('hrd.delete_announcement', $listannoun->id) }}"
                                                            role="button"
                                                            onclick="deleteConfirm(event, '{{ route('hrd.delete_announcement', $listannoun->id) }}')"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('hrd.updatestatus_announcement', $listannoun->id) }}"
                                                            onclick="UpdateStatusConfirm(event, '{{ route('hrd.updatestatus_announcement', $listannoun->id) }}')"
