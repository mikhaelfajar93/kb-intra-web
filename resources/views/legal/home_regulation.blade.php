...
@section('content_header')
    @can('add legal')
        <a href="/legal-input-regulation" class="btn btn-danger">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Regulation Legal</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                                            ...
                                            <td>
                                                <div class="mb-2 d-flex align-items-center">
                                                    <a class="btn btn-light btn-icon btn-sm rounded-pill"
                                                        href="{{ route('legal.view_regulation', $listregulation->id) }}"
                                                    ...
                                                    @can('update legal')
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.edit_regulations', $listregulation->id) }}"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.delete_regulation', $listregulation->id) }}"
                                                            role="button"
                                                            onclick="deleteConfirm(event, '{{ route('legal.delete_regulation', $listregulation->id) }}')"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.updatestatus_regulation', $listregulation->id) }}"
                                                            onclick="UpdateStatusConfirm(event, '{{ route('legal.updatestatus_regulation', $listregulation->id) }}')"
