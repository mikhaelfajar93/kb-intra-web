...
@section('announcement_legal_active', 'active')
@section('content')
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Edit Announcement Legal</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form role="form" action="{{ route('comp.update_announcements', $announcements->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="title_announcement_legal"
                                    name="title_announcement_legal" value="{{ $announcements->title }}"
                                    placeholder="Enter Title">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleFormControlTextarea1">Details</label>
                                <textarea class="form-control" id="detail_announcement_legal" name="detail_announcement_legal" rows="5">{{ $announcements->details }}</textarea>
                            </div>
