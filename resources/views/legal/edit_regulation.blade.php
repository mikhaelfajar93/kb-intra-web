                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">Edit Regulation Legal</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                            ...
                            @endforeach
                        @endif
                        <form role="form" action="{{ route('legal.update_regulations', $regulations->id) }}"
                            method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                <label class="form-label" for="exampleInputText1">Title Announcement </label>
                                <input type="text" class="form-control" id="title_news_legal" name="title_news_legal"
                                    value="{{ $regulations->title }}" placeholder="Enter Title">
                            </div>
                            <div class="form-group">
                                <label class="form-label" for="exampleFormControlTextarea1">Details</label>
                                <textarea class="form-control" id="detail_news_legal" name="detail_news_legal" rows="5">{{ $regulations->details }}</textarea>
                            </div>
                            ...
                            <div class="mt-3 mt-sm-0">
                                <a href="/regulation_legal" role="button" data-toggle="tooltip" title="Back"
