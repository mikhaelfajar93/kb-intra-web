...
@section('announ_legal_active', 'active') --}}
@section('announcement_active', 'active')
@section('content_header')
    @can('add legal')
        <a href="/legal-input-announcement" class="btn btn-danger">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Announcement Legal</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <div class="table-responsive">
                            <table id="datatable" class="table table-striped" data-toggle="data-table">
                                ...
                                <tbody>
                                    @foreach ($list_announ as $listannoun)
                                        <tr>
                                            <td> {{ ucfirst($listannoun->title) }}</td>
                                            <td>{{ ucfirst($listannoun->uploadby) }}</td>
                                            <td>{{ date('d F Y', strtotime($listannoun->created_at)) }}</td>
                                            <td>
                                                @if ($listannoun->status == 1)
                                                    Post
                                                @else
                                                    Unpost
                                                @endif
                                            ...
                                            <td>
                                                <div class="mb-2 d-flex align-items-center">
                                                    <a class="btn btn-light btn-icon btn-sm rounded-pill" href=""
                                                    ...
                                                    @can('update legal')
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.edit_announcements', $listannoun->id) }}"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.delete_announcement', $listannoun->id) }}"
                                                            role="button"
                                                            onclick="deleteConfirm(event, '{{ route('legal.delete_announcement', $listannoun->id) }}')"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('legal.updatestatus_announcement', $listannoun->id) }}"
                                                            onclick="UpdateStatusConfirm(event, '{{ route('legal.updatestatus_announcement', $listannoun->id) }}')"
