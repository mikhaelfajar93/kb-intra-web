                            ...
                            <div class="card-body">
                                ...
                                @if ($file_regulation->isNotEmpty())
                                    <div class="d-flex justify-content-start my-4">
                                        ...
                                        <p class="text-primary m-0 ms-2">{{ $count_file_regulation }} files attached</p>
                                    </div>
                                @endif
                                <div class="row">
                                    @foreach ($file_regulation as $listfile)
                                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                            <div class="bg-body rounded mb-4">
                                                <div class="d-flex align-items-center p-4">
                                                    <div class="w-100">
                                                        <a href="{{ route('comp.download_file_regulation', $regulations->id) }}"
