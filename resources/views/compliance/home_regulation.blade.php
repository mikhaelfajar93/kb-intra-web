...
@section('content_header')
    @can('add compliance')
        <a href="/comp-input-regulation" class="btn btn-danger">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div class="header-title">
                            <h4 class="card-title">List Regulation Compliance</h4>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                                            ...
                                            <td>
                                                <div class="mb-2 d-flex align-items-center">
                                                    <a class="btn btn-light btn-icon btn-sm rounded-pill"
                                                        href="{{ route('comp.view_regulation', $listregulation->id) }}"
                                                    ...
                                                    @can('update compliance')
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('comp.edit_regulations', $listregulation->id) }}"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('comp.delete_regulation', $listregulation->id) }}"
                                                            role="button"
                                                            onclick="deleteConfirm(event, '{{ route('comp.delete_regulation', $listregulation->id) }}')"
                                                        ...
                                                        <a class="btn btn-light btn-icon btn-sm rounded-pill ms-2"
                                                            href="{{ route('comp.updatestatus_regulation', $listregulation->id) }}"
                                                            onclick="UpdateStatusConfirm(event, '{{ route('comp.updatestatus_regulation', $listregulation->id) }}')"
