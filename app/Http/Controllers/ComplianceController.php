...
class ComplianceController extends Controller
{
    ...
    public function page_dashboard_announcement()
    {
        ...
        if ($role == 'Compliance') {
            $list_announ = Announcement::where('roleby', '=', 'Compliance')->get();
        } else {
            $list_announ = Announcement::where('roleby', 'Compliance')
                ->where('status', 1)
                ->get();
        }

        return view('compliance.home_announcement', compact('username', 'role', 'list_announ'));
    }
    ...
    public function page_dashboard_regulation()
    {
        ...
        if ($role == 'Compliance') {
            $list_regulation = Regulation::where('roleby', '=', 'Compliance')->get();
        } else {
            $list_regulation = Regulation::where('roleby', 'Compliance')
                ->where('status', 1)
                ->get();
        }

        return view('compliance.home_regulation', compact('username', 'role', 'list_regulation'));
    }
    ...
    public function page_input_announcement()
    {
        ...
        return view('compliance.add_announcement', compact('username', 'role'));
    }
    ...
    public function page_input_regulation()
    {
        ...
        return view('compliance.add_regulation', compact('username', 'role'));
    }
    ...
    public function input_regulation(Request $request)
    {
        ...
        $regulations->title = $request->title_regulation_comp;
        $regulations->details = $request->detail_regulation_comp;
        ...
        $validator = Validator::make($request->all(), [
            'file_regulation_comp.*' => 'file|mimes:jpg,jpeg,png,pdf,doc,docx,xls,xlsx,ppt,pptx||max:' . $maxFileSize,
        ]);
        ...
        $file_regulation = [];
        if ($request->hasFile('file_regulation_comp')) {
            foreach ($request->file('file_regulation_comp') as $value) {
    ...
    public function input_announcement(Request $request)
    {
        ...
        $annoucements->title = $request->title_announ_comp;
        $annoucements->details = $request->detail_announ_comp;
        ...
        $maxFileSize = 12 * 1024; //maxium size file upload
        $validator = Validator::make($request->all(), [
            'file_announ_comp.*' => 'file|mimes:jpg,jpeg,png,pdf,doc,docx,xls,xlsx,ppt,pptx||max:' . $maxFileSize,
        ]);
        ...
        $file_announcement = [];
        if ($request->hasFile('file_announ_comp')) {
            foreach ($request->file('file_announ_comp') as $value) {
                $filename = $value->getClientOriginalName();
    ...
    public function edit_regulation($idregulation)
    {
        ...
        if ($regulations->status == 0) {
            return view('compliance.edit_regulation', compact('username', 'role', 'regulations', 'file_regulation', 'count_file_regulation'));
        } else {
            ...
            return redirect()->route('regulation_compliance');
        }
    ...
    public function edit_announcement($idannouncement)
    {
        ...
        $list_announcement = Announcement::where('roleby', '=', 'Compliance')->get();

        if ($announcements->status == 0) {
            return view('compliance.edit_announcement', compact('username', 'role', 'announcements', 'file_announcement', 'count_file_announcement'));
        } else {
            session(['username' => $username, 'role' => $role]);
            session()->flash('status', 'You cannot update regulation because the regulation has been posted');
            // return redirect()->route('regulation_compliance')->with(compact('username', 'role', 'list_regulation'));
            return redirect()->route('announ_compliance');
        }
    ...
    public function view_regulation($idregulation)
    {
        ...
        return view('compliance.view_regulation', compact('username', 'role', 'regulations', 'file_regulation', 'count_file_regulation'));
    }
    ...
    public function view_announcement($idannouncement)
    {
        ...
        return view('compliance.view_announcement', compact('username', 'role', 'announcements', 'file_announcement', 'count_file_announcement'));
    }
